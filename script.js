...
class SpotifyWrapper extends API {
  ...
  findTrack({ artist, track }) {
    if (this.accessToken === null) {
      return new Promise((res, rej) => rej('Nenhum token de acesso foi encontrado'));
    }
    return this.get({
      url: 'search/',
      data: {
...
function getTrack(lyrics, success, progress, fail) {
  progress(`Buscando faixa usando "${lyrics}"`);
  genius.
  search({
    lyrics: lyrics }).
...
class DisplayLyrics extends React.Component {
  ...
  render() {
    let lyrics = 'Olá, clique no microfone, fale a letra, álbum ou artista...';
...
class Home extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("span", null, "Limpar Busca")))),
...
class Results extends React.Component {
  ...
  render() {
    ...
    let img = 'https://fabiotech.github.io/Voice/200x200.png';
    ...
    return (
      ...
      React.createElement(DeferImage, { src: img, placehold: "https://fabiotech.github.io/Voice/200x200.png", fade: "2000" }))),
      ...
      React.createElement(DeferImage, { src: image_url, placehold: "https://fabiotech.github.io/Voice/200x200.png", fade: "1750" }))),
...
let Support = () => {
  return (
    ...
    React.createElement("h1", null, "Oh, isso é um pouco estranho."),
    React.createElement("p", null, "Você precisará do Chrome ou Opera para usar este aplicativo."),
    React.createElement("p", null, "Infelizmente, * ainda não há suporte * no iPhone ou iPad."),
    React.createElement("button", {
